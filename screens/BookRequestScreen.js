    ...
    render() {
        ...
        if (this.state.IsBookRequestActive === true) {
            return (
                ...
                <
                View style = {
                    { borderColor: "orange", borderWidth: 2, justifyContent: 'center', alignItems: 'center', padding: 10, margin: 10 } } >
                <
                Text > Book Name < /Text> <
                ...
                TouchableOpacity style = {
                    { borderWidth: 1, borderColor: 'orange', backgroundColor: "orange", width: 300, alignSelf: 'center', alignItems: 'center', height: 30, marginTop: 30 } }
                onPress = {
                    () => {
                    ...
                    this.state.showFlatlist ?
                        ...
                        ( < FlatList data = { this.state.dataSource }
                            ...
                            /> ): ( <
                                ...
                                <
                                TextInput style = {
                                    [styles.formTextInput, { height: 300 }] }
